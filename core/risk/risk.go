...
type Report struct {
	...
	ComposedActionPaths              []ComposedActionPath                 `json:"composed_action_paths,omitempty"`
	ComposedActionPathToControlFirst *ComposedActionPathToControlFirst    `json:"composed_action_path_to_control_first,omitempty"`
