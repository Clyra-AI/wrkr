...
func runLifecycle(args []string, stdout io.Writer, stderr io.Writer) int {
	...
	reportTemplate := fs.String("template", "audit", "summary template [exec|operator|audit|public|ciso|appsec|platform|customer-draft|agent-action-bom|design-partner-summary]")
	reportShareProfile := fs.String("share-profile", "", "summary share profile [internal|public|customer-redacted|design-partner|external-redacted|investor-safe]")
