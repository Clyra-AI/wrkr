...
scripts/test_uat_local.sh --release-version v1.12.1 --skip-global-gates
scripts/test_uat_local.sh --release-version v1.12.1 --brew-formula Clyra-AI/tap/wrkr --skip-global-gates
```
