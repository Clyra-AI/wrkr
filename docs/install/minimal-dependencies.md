...
scripts/test_uat_local.sh --release-version v1.8.0 --skip-global-gates
scripts/test_uat_local.sh --release-version v1.8.0 --brew-formula Clyra-AI/tap/wrkr --skip-global-gates
```
