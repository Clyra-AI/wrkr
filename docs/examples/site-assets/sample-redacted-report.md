...
- egress with target scope developer productivity: 4 paths; high severity; review queue priority; attach evidence closure.
...
- read with target scope developer productivity: 2 paths; high severity; review queue priority; attach evidence closure.
...
- read with target scope unknown: 2 paths; high severity; review queue priority; attach evidence closure.
...
- Production-impact-inferred paths: 2
- Top path to control first: repo-10e08a loc-f27ac6f3 (control)
...
- repo-eb0de2 loc-415e1600 owner=owner-80965586 queue=control_first visibility=primary action=remediate sla=7d closure=Assign explicit owner evidence for this workflow path and attach a linked owner record before approving or expanding it. remediation=Replace the standing credential with brokered or JIT access where possible, attach rotation evidence, and rescan to confirm the reduced blast radius.
  completeness=partial evidence coverage(60)
