...
- Packet: pacpkt-605451d397e27723
- Artifact: paca-63c9cd9fff151ec9
- Contract: pac-5c4abdf8ad037d3e
- Family: pacf-7d71940f2e697bfd
- Revision: 1
- Supersedes: none
- Contract digest: sha256:7445fc4a2c776256c2a769f161f27e20943dc0eac1ce84338250e012643e2113
- Artifact digest: sha256:63c9cd9fff151ec9ea835845f776455851cb50746fba9e4831c4d7f9fe90849a
...
- `pacr-f75629fd1623b069` credential_subject_constraint: required=credential_subject:required observed=binding_subject:cloud_admin_key,binding_subject:workflow_kubernetes_deploy,provenance_subject:broad_pat,provenance_subject:cloud_admin_key,provena … [truncated] evidence=unknown freshness=unknown refs=.gait/policy.yaml, approval_status=unapproved, authority_standing:true, baseline:discovered_surface, binding_subject:cloud_admin_key, binding_subject:workflow_kubernetes_deploy, credential_likely_scope:source_control_write, credential_present:true
...
- `pacr-3190be934a507333` requester_identity: required=requester_identity:required observed=not_observed evidence=unknown freshness=unknown refs=.gait/policy.yaml, approval_status=unapproved, authority_standing:true, baseline:discovered_surface, binding_subject:cloud_admin_key, binding_subject:workflow_kubernetes_deploy, credential_likely_scope:source_control_write, credential_present:true
...
- Freshness: unknown
- Requirement refs: pacp-823d0aa357f5970d, pacr-3190be934a507333, pacr-f75629fd1623b069
- Wrkr activation grant: false

## Readiness Checks

- `pacp-823d0aa357f5970d` credential_mode: required=credential_mode:ephemeral observed=standing result=standing evidence=contradictory freshness=unknown producers=credential_authority
...
- `pacp-a445b21b29148072` policy_digest: required=policy_digest:required observed=sha256:e308ef8cbf7b45d93c12b7c1548f16c572907d93d88bac23e606af7b0449aeb6 result=sha256:e308ef8cbf7b45d93c12b7c1548f16c572907d93d88bac23e606af7b0449aeb6 evidence=unknown freshness=unknown producers=control_declaration, gait_policy
- `pacp-ff01ec5b04af48a0` producer: required=producer:approved observed=not_observed result=not_observed evidence=unknown freshness=unknown producers=ci, control_declaration, gait_policy
...
- `pacr-533be8ab758a94db` authority:affected_system_owner: evidence=unknown freshness=unknown reasons=authority:affected_system_owner:unknown
...
- `pacr-f75629fd1623b069` authority:credential_subject_constraint: evidence=unknown freshness=unknown reasons=authority:credential_subject_constraint:unknown
...
- `pacr-454405758b3f2821` authority:originating_intent: evidence=unknown freshness=unknown reasons=authority:originating_intent:unknown
- `pacr-d03bed5763b7dd9a` authority:permitted_agent_role: evidence=unknown freshness=unknown reasons=authority:permitted_agent_role:missing, authority:permitted_agent_role:unknown
- `pacr-d38724511d32c457` authority:policy_authority: evidence=unknown freshness=unknown reasons=authority:policy_authority:unknown
- `pacr-3190be934a507333` authority:requester_identity: evidence=unknown freshness=unknown reasons=authority:requester_identity:missing, authority:requester_identity:unknown
...
- `pacp-823d0aa357f5970d` precondition:credential_mode: evidence=contradictory freshness=unknown reasons=precondition:credential_mode:contradictory, precondition:credential_mode:unknown
...
- authority_requirements.pacr-1441d51532a88fce.evidence_refs: reason=item_cap omitted=31
- authority_requirements.pacr-2fc2c5994f3b196e.evidence_refs: reason=item_cap omitted=31
- authority_requirements.pacr-3190be934a507333.evidence_refs: reason=item_cap omitted=31
- authority_requirements.pacr-3d491303f43f46f3.evidence_refs: reason=item_cap omitted=31
- authority_requirements.pacr-454405758b3f2821.evidence_refs: reason=item_cap omitted=31
- authority_requirements.pacr-533be8ab758a94db.evidence_refs: reason=item_cap omitted=31
- authority_requirements.pacr-d03bed5763b7dd9a.evidence_refs: reason=item_cap omitted=31
- authority_requirements.pacr-d38724511d32c457.evidence_refs: reason=item_cap omitted=31
- authority_requirements.pacr-f75629fd1623b069.evidence_refs: reason=item_cap omitted=31
- authority_requirements.pacr-f75629fd1623b069.observed_value: reason=value_rune_cap omitted=20
- readiness_checks.pacp-1287c4d1aeda06dc.evidence_refs: reason=item_cap omitted=31
- readiness_checks.pacp-2c16750a26bab153.evidence_refs: reason=item_cap omitted=31
