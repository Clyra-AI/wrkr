...
func TestCompositionFieldsReachAggregateSchemas(t *testing.T) {
	...
	compositionRequireProperty(t, compositionDefinitionProperties(t, bomSchema, "primaryView"), "composition_ids")
	compositionRequireProperty(t, compositionDefinitionProperties(t, bomSchema, "primaryView"), "proposed_action_contract_refs")
}
