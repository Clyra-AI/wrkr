...
- Sprint 0 subtractive fixes keep a temporary freeze gate in place: do not add new scan/report surface area unless it is directly required by Stories 1.1 through 4.2 or the size, redaction, and readability gates are green. recursive redaction and clone-strip contracts are part of that temporary freeze gate.
