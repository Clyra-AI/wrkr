...
func TestScenarioContracts(t *testing.T) {
	...
	requiredPaths := []string{
		...
		"scenarios/wrkr/js-ts-enterprise/README.md",
		"scenarios/wrkr/js-ts-enterprise/repos",
		...
		"scenarios/cross-product/composed-action-contracts/expected/gait-validation-input.json",
		"scenarios/cross-product/composed-action-contracts/expected/axym-correlation-refs.json",
		"scenarios/README.md",
